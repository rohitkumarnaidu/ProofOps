...
# NOTE: the retired dev-only DB default is deliberately NOT listed here —
# it was purged from history (GitGuardian) and must never reappear verbatim.
PLACEHOLDER_MARKERS = ("change-me", "dev-key-change-me")
