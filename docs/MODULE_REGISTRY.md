...
| M00.6 | documentation foundation | IMPLEMENTED, awaiting verdict | N | N | N | N | 8-docs presence + spec-link tests |
...
| ID | Unit | Status | Safety | Ground | Hall | Retr | Verify method |
|---|---|---|---|---|---|---|---|
| M01.1 | shared types | NOT STARTED | S | N | N | N | schema unit + 20-invalid-fixture tests |
